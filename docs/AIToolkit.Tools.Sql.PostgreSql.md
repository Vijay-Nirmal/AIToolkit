# AIToolkit.Tools.Sql.PostgreSql

`AIToolkit.Tools.Sql.PostgreSql` exposes PostgreSQL access as `Microsoft.Extensions.AI` functions with a stateless `pgsql_*` tool surface.
