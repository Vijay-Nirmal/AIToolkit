...
if (string.IsNullOrWhiteSpace(apiKey))
{
    ...
    Console.Error.WriteLine("dotnet user-secrets set \"OpenAI:ApiKey\" \"<your-api-key>\" --project samples/AIToolkit.Tools.Sql.SqlServer.Sample");
    return;
}
...
static async Task EnsureSampleDatabaseAsync(string adminConnectionString, string databaseName)
{
    var masterConnectionString = BuildConnectionString(
        ...
        "master",
        "AIToolkit.Tools.Sql.SqlServer.Sample.Setup");
