...
/// <summary>
/// Contributes provider-specific guidance to the generic <c>Deck_*</c> tool descriptions and system prompt text.
/// </summary>
/// <remarks>
...
/// </remarks>
public interface IDeckToolPromptProvider
{
    /// <summary>
    ...
    DeckToolPromptContribution GetPromptContribution();
}

/// <summary>
/// Holds provider-specific prompt lines that are merged into Deck tool descriptions and system prompt guidance.
/// </summary>
/// <remarks>
...
public sealed record DeckToolPromptContribution(
