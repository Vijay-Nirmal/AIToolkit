...
`AIToolkit.Tools.Sql` contains the shared contracts used by database-specific AIToolkit packages.
...
Most applications will use a provider package such as `AIToolkit.Tools.Sql.SqlServer` directly.